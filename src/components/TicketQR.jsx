...
const TicketQRGenerator = () => {
  ...
  const qrValue = `https://ojus-culturals.vercel.app/ticket9981257890?name=${encodeURIComponent(userData.name)}&moodleId=${encodeURIComponent(userData.moodle_id)}`;

  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      <div className="bg-white shadow-lg rounded-2xl p-6 border border-gray-300 w-96 text-center">
        <h2 className="text-xl font-bold mb-4">Your Theatre Ticket</h2>
        <div className="mb-4">
