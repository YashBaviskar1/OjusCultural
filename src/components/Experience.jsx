  ...
  return useMemo(
    () => (
      <>
        ...
        <TextSection {...textSections[1]} />
        <TextSection {...textSections[2]} />
        <TextSection {...textSections[3]} />
        ...
        {/* Starting Clouds */}
        <group>
          <Cloud sceneOpacity={sceneOpacity} position={new Vector3(-3.522, -3.2, -7)} />
          <Cloud sceneOpacity={sceneOpacity} position={new Vector3(3.5, -4, -10)} />
          <Cloud
